# https://hub.docker.com/r/jenkins/inbound-agent/tags?ordering=last_updated&name=3206.
FROM jenkins/inbound-agent:3206.vb_15dcf73f6a_9-12-jdk17 AS jnlp
...
ARG VERSION=3206.vb_15dcf73f6a_9-12
ARG user=jenkins
ARG group=jenkins
ARG uid=1000
ARG gid=1000
