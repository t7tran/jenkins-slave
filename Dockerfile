# https://hub.docker.com/r/jenkins/inbound-agent/tags?ordering=last_updated&name=3345.
FROM jenkins/inbound-agent:3345.v03dee9b_f88fc-2-jdk17 AS jnlp
...
ENV COMPOSER_HOME=/.composer \
    ...
    AWSCLI_VERSION=2.31.25 \
    # apt-cache madison docker-ce
    DOCKER_VERSION=5:28.5.1-1~ubuntu.24.04~noble \
