# https://hub.docker.com/r/jenkins/inbound-agent/tags?ordering=last_updated&name=3142.
FROM jenkins/inbound-agent:3142.vcfca_0cd92128-1 AS jnlp
...
ENV COMPOSER_HOME=/.composer \
    ...
    SQLPROXY_VERSION=2.6.1 \
    # https://github.com/aws/aws-cli/tags
    AWSCLI_VERSION=2.13.13 \
...
ARG VERSION=3142.vcfca_0cd92128-1
ARG user=jenkins
ARG group=jenkins
ARG uid=1000
ARG gid=1000
