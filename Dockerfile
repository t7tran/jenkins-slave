# https://hub.docker.com/r/jenkins/inbound-agent/tags?ordering=last_updated&name=3131.
FROM jenkins/inbound-agent:3131.vf2b_b_798b_ce99-3 AS jnlp
...
ARG VERSION=3131.vf2b_b_798b_ce99-3
ARG user=jenkins
ARG group=jenkins
ARG uid=1000
ARG gid=1000
